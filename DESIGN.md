...
| layout_apply | レイアウトの更新を通知する。 | `{'left-column': ['rank-progression', ...], 'right-column': ['combat', ...], 'collapsed': {'toggle-progress': true}}` |
...
| layout_update | レイアウトの変更をサーバに通知する。 | `{'left-column': ['rank-progression', ...], 'right-column': ['combat', ...], 'collapsed': {'toggle-progress': true}}` |
